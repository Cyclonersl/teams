...
const mapDispatchToProps = dispatch => ({
  ...
  addTeamService: (team, service) =>
    dispatch(teamsAction.addService(team, service)),
  addSchedService: service =>
    dispatch(schedServicesAction.addSchedService(service)),
  remSchedService: service =>
    dispatch(schedServicesAction.remSchedService(service))
});
